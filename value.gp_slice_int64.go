...
//   [github.com/gxlb/cli/value.gpg] [value_int64_slice]
//
...
func NewInt64SliceSlice(defaults ...int64) *Int64SliceSlice {
	return &Int64SliceSlice{slice: append([]int64{}, defaults...)}
}
...
// Int64SliceValue define a value of type *Int64SliceSlice
type Int64SliceValue struct {
	...
	Ranges      []int64          // {[min,max),[min,max),[min...)} ranges of valid values
	value       *Int64SliceSlice // The value from ENV of files
	hasBeenSet  bool             // if the value was set
	flag        *Flag            // pointer of owner flag
}

// Init verify and init the value by ower flag
func (v *Int64SliceValue) Init(f *Flag) error {
	v.flag = f
...
func (v *Int64SliceValue) IsSet() bool {
	return v.value.hasBeenSet
}

// Apply coordinate the value to flagset
func (v *Int64SliceValue) Apply(set *flag.FlagSet) error {
	return nil
}
...
func (v *Int64SliceValue) ValidateValues() error {
	return v.validateValues(v.value)
}

// for default value verify
func (v *Int64SliceValue) validateValues(values *Int64SliceSlice) error {
...
func (v *Int64SliceValue) validValue(value int64) error {
	f := v.flag
	if len(v.Enums) > 0 {
		found := false
...
var _ Value = (*Int64SliceValue)(nil) //for interface verification only
