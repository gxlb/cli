...
func NewFloat64SliceSlice(defaults ...float64) *Float64Slice {
	return &Float64Slice{
...
func (s *Float64Slice) clone() *Float64Slice {
	n := &Float64Slice{
...
func (s *Float64Slice) AppendValues(values ...float64) {
	s.setValues(false, values)
}

// SetValues directly overite values to the list of values
func (s *Float64Slice) SetValues(values ...float64) {
	s.setValues(true, values)
}

func (s *Float64Slice) setValues(overwrite bool, values []float64) {
...
func (s *Float64Slice) Serialize() string {
...
// Float64SliceFlag define a value of type *Float64Slice
type Float64SliceFlag struct {
	...
	//value related area
	//
	Target      *Float64Slice // Target value pointer outside
	Default     *Float64Slice // Default value
	...
	////////////////////////////////////////////////////////////////////////////
	//area for parsing
	target *Float64Slice // target value pointer(maybe new(*Float64Slice) if Target not set)
...
func (f *Float64SliceFlag) validateValues(values *Float64Slice) error {
