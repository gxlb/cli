...
// Last update at: [Mon Feb 22 2021 16:10 CST]
// Generate from:
...
func (s *StringSlice) AppendValues(values ...string) {
	s.setValues(false, values)
}

// SetValues directly overite values to the list of values
func (s *StringSlice) SetValues(values ...string) {
	s.setValues(true, values)
}

func (s *StringSlice) setValues(overwrite bool, values []string) {
...
// StringSliceFlag define a value of type *StringSlice
type StringSliceFlag struct {
	...
	//value related area
	//
	Target      *StringSlice // Target value pointer outside
	...
	////////////////////////////////////////////////////////////////////////////
	//area for parsing
	target *StringSlice  // target value pointer(maybe new(*StringSlice) if Target not set)
...
func (f *StringSliceFlag) validateValues(values *StringSlice) error {
