...
//#GOGP_REPLACE(*<REPELEM_TYPE>, *<GLOBAL_NAME_PREFIX>Slice)
//#GOGP_REPLACE(<REPELEM_TYPE>, *<GLOBAL_NAME_PREFIX>Slice)

//#GOGP_ELSE //SLICE_TYPE

//#GOGP_REPLACE(GOGPREPSingleValue, values)
//#GOGP_REPLACE(<REPELEM_TYPE>, <VALUE_TYPE>)

//#GOGP_ENDIF //SLICE_TYPE

// <GLOBAL_NAME_PREFIX>Value define a value of type GOGPElemType
type <GLOBAL_NAME_PREFIX>Value struct {
	Target      *<REPELEM_TYPE> // Target value pointer outside
	Default     <REPELEM_TYPE>  // Default value
	...
	value       <REPELEM_TYPE>  // The value from ENV of files
...
func (v *<GLOBAL_NAME_PREFIX>Value) validateValues(values <REPELEM_TYPE>) error {
	//#GOGP_IFDEF SLICE_TYPE
