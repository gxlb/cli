...
// Last update at: [Mon Feb 22 2021 10:52 CST]
// Generate from:
...
// // <GLOBAL_NAME_PREFIX> looks up the value of a local <GLOBAL_NAME_PREFIX>Flag, returns
// // nil if not found
// func (c *Context) <GLOBAL_NAME_PREFIX>(name string) []<VALUE_TYPE> {
...
// func lookup<GLOBAL_NAME_PREFIX>(name string, set *flag.FlagSet) []<VALUE_TYPE> {
// 	f := set.Lookup(name)
// 	if f != nil {
