...
//   [github.com/gxlb/cli/value.gpg] [value_float64_slice]
//
...
// Float64SliceValue define a value of type *Float64SliceSlice
...
func (v *Float64SliceValue) IsSet() bool {
	return v.value.hasBeenSet
}

// Apply coordinate the value to flagset
func (v *Float64SliceValue) Apply(set *flag.FlagSet) error {
	return nil
}
...
func (v *Float64SliceValue) ValidateValues() error {
	return v.validateValues(v.value)
}

// for default value verify
func (v *Float64SliceValue) validateValues(values *Float64SliceSlice) error {
...
func (v *Float64SliceValue) validValue(value float64) error {
	f := v.flag
	if len(v.Enums) > 0 {
		found := false
...
var _ Value = (*Float64SliceValue)(nil) //for interface verification only
